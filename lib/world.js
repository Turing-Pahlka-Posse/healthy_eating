...
function World(height, width, canvas) {
  ...
  this.createNewHealthyFood = function(speed){
    // this.healthyFood.shift();
    console.log('test')
    this.healthyFood.push(new Obstacle(this.canvas, this.playerHitBoxes, 700, this.generateNewHealthyFoodX(), 32, 25, speed, 'mushroom', this.appleImage));
  };
