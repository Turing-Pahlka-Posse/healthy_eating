...
function Game(canvas) {
  ...
  this.executeMilksplatFunctions = function(){
    if (this.world.checkIfFishAteMilksplat() === true){
      this.rainbowModeDuration = 0;
    ...
    if(this.distanceCount % 500 === 0){//generate new mushroom
      this.world.createNewMilksplat(this.speed);
    }
  };

  this.executeHealthyFoodFunctions = function(){

    if (this.world.checkIfFishAteHealthyFood() === true){
      // this.rainbowModeDuration = 0;
      // this.rainbowMode = true;
      this.showBonusText = true;
      this.scoreboard.addValueToScore(500);
    ...
    if(this.distanceCount % 100 === 0){//generate new healthyFood
      this.world.createNewHealthyFood(this.speed);
    }
  }
  ...
  this.gameFrame = function(){
    ...
    this.executeMilksplatFunctions();

    this.executeHealthyFoodFunctions();
